...
public class CreateShortcut extends LauncherActivity {
    ...
    protected Intent getTargetIntent() {
        ...
        targetIntent.addCategory("com.xenon.romsettings.SHORTCUT");
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        shortcutIntent.setAction("com.xenon.romsettings.START_NEW_FRAGMENT");
        shortcutIntent.putExtra("xenon_fragment_name", intentClass);
